...
# 📝 **جميع الرسائل العشر كاملة باللغة العربية فقط**
messages = [
    "Hemleghkm luna 💞\n\n"
    ...
    "لا أستطيع أن أتخيل أن تكوني مع شخص آخر، أو أن أكون مع امرأة أخرى، هذا مزعج! Izan، أريد أن أكون معكِ، وأعيش معكِ، وأن يكون لي بنات يشبهنكِ، منكِ أنتِ.",
    ...
    "لقد حزنت كثيرًا، وكان شعورًا سيئًا... الساعات أصبحت كالسنوات فجأة بالنسبة لي.",
...
async def send_welcome(message: types.Message):
    await message.answer(messages[0], reply_markup=get_keyboard(1))
...
async def process_callback(callback_query: types.CallbackQuery):
    ...
    if index < len(messages):
        await callback_query.message.edit_text(messages[index], reply_markup=get_keyboard(index + 1))
